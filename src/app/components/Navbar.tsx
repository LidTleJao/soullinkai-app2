    ...
    if (!mounted) {
      return (
        <div className="hidden md:flex items-center space-x-4 opacity-50">
          <span className="btn btn-ghost btn-sm pointer-events-none">Loading…</span>
          <Theme_Controller />
        </div>
      );
    }
    ...
    if (loggedIn) {
      return (
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link href="/Personas" className="btn btn-ghost">Dashboard</Link>
          <Link href="/Subscription" className="btn btn-ghost">Subscription</Link>
          <Link href="/Feedback" className="btn btn-ghost">Feedback</Link>
          <Link href="/Security" className="btn btn-ghost">Security</Link>
          <Link href="/Summarize" className="btn btn-ghost">Summarize</Link>
          <button
